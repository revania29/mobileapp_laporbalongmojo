...
class _DashboardScreenPerangkatState extends State<DashboardScreenPerangkat> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => 
      Provider.of<LaporanProvider>(context, listen: false).fetchAllLaporanAdmin()
    );
  }
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).pushNamed(ListLaporanAdminScreen.routeName);
                      },
                    ),
                  ),
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                      onTap: () {
                        Navigator.of(context).pushNamed(FormBeritaScreen.routeName);
                      },
                    ),
                  ),
                ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: color.withOpacity(0.4), blurRadius: 4, offset: const Offset(0, 4))],
      ),
      child: Column(
        children: [
